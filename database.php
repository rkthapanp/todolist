    ...
    <?php
        if ($result->num_rows > 0){
            while ($row = $result->fetch_assoc()){
                ...
                $msg .= "<td><a href='index.php?page=detail&id=" . $row['taskID'] . "' ><span class='fa fa-eye'></span></td>";
                $msg .= "<td><a href='index.php?page=edit&id=" . $row['taskID'] . "' ><span class='fa fa-edit'></span></td>";
                $msg .= "<td><a href='index.php?page=delete&id=" . $row['taskID'] . "' ><span class='fa fa-check'></span></td>";
                $msg .= "</tr>";
                echo $msg;
            }
        }
